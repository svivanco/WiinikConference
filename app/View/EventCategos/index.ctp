<div class="col-md-12">
	...
	<thead>
        <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('backcolor'); ?></th>
                    <th><?php echo $this->Paginator->sort('textcolor'); ?></th>
                    <th class="actions">Acciones</th>
        </tr>
    </thead>
    <tbody>
	<?php foreach ($eventCategos as $eventCatego): ?>
	<tr>
		<td><?php echo h($eventCatego['EventCatego']['id']); ?>&nbsp;</td>
		<td><?php echo h($eventCatego['EventCatego']['categoria']); ?>&nbsp;</td>
		<td><?php echo h($eventCatego['EventCatego']['backcolor']); ?>&nbsp;</td>
		<td><?php echo h($eventCatego['EventCatego']['textcolor']); ?>&nbsp;</td>
		<td>
			<div class='botones'><div class='btn-group'>
				<?php echo $this->Html->link('', array('action' => 'view', $eventCatego['EventCatego']['id']),array('class'=>'btn btn-default glyphicon glyphicon-eye-open')); ?>
				<?php echo $this->Html->link('', array('action' => 'edit', $eventCatego['EventCatego']['id']),array('class'=>'btn btn-default glyphicon glyphicon-edit')); ?>
				<?php echo $this->Form->postLink('', array('action' => 'delete', $eventCatego['EventCatego']['id']), array('class'=>'btn btn-default glyphicon glyphicon-remove'), __('Realmente desea eliminar el registro con Id %s?', $eventCatego['EventCatego']['id'])); ?>
			</div></div>
		</td>
	</tr>
<?php endforeach; ?>
