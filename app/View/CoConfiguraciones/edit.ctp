...
<div class="col-md-2 well">
    ...
    <ul class="nav">
        ...
        <li><?php echo $this->Form->postLink('Eliminar', array('action' => 'delete', $this->Form->value('CoConfiguracione.id')), null, __('Realmente desea eliminar el registro con Id %s?', $this->Form->value('CoConfiguracione.id'))); ?></li>
        <li><?php echo $this->Html->link('Listado', array('action' => 'index')); ?></li>
            </ul>
</div>
<div class="col-md-10">
    <h3>
        <?php echo __('Editar Co Configuracione'); ?>    </h3>
