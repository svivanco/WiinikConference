<div class="col-md-12">
	...
	<tr>
		<td><?php echo h($aeropuerto['Aeropuerto']['id']); ?>&nbsp;</td>
		<td><?php echo h($aeropuerto['Aeropuerto']['nombre']); ?>&nbsp;</td>
		<td>
			<div class='botones'><div class='btn-group'>
				<?php echo $this->Html->link('', array('action' => 'view', $aeropuerto['Aeropuerto']['id']),array('class'=>'btn btn-default glyphicon glyphicon-eye-open')); ?>
				<?php echo $this->Html->link('', array('action' => 'edit', $aeropuerto['Aeropuerto']['id']),array('class'=>'btn btn-default glyphicon glyphicon-edit')); ?>
				<?php echo $this->Form->postLink('', array('action' => 'delete', $aeropuerto['Aeropuerto']['id']), array('class'=>'btn btn-default glyphicon glyphicon-remove'), __('Realmente desea eliminar el registro con Id %s?', $aeropuerto['Aeropuerto']['id'])); ?>
			</div></div>
		</td>
	</tr>
<?php endforeach; ?>
