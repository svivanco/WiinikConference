...
<div class="col-md-2 well2">
    ...
    <ul class="nav">
        ...
        <li><?php echo $this->Form->postLink('Eliminar', array('action' => 'delete', $this->Form->value('Aeropuerto.id')),array('class'=>'btn glyphicon glyphicon-remove'), __('Realmente desea eliminar el registro con Id %s?', $this->Form->value('Aeropuerto.id'))); ?></li>
        <li><?php echo $this->Html->link('Listado', array('action' => 'index'),array('class'=>'btn glyphicon glyphicon-list')); ?></li>
            </ul>
</div>
<div class="col-md-10">
    <h3>
        <?php echo __('Editar Aeropuerto'); ?>    </h3>
    <?php echo $this->Form->create('Aeropuerto',array('onsubmit'=>'return checkSubmit();','role'=>'form','class'=>'form-horizontal')); ?>
	<fieldset>
