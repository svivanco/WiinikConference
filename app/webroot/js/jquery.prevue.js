...
(function($) {
	...
	$.fn.prevue = function(settings) {
		...
		var defaults = {
			fontIconClassNameOff: 'glyphicons eye_close', // These are interchanged since when preview is off you'll want show the 'on' icon
			fontIconClassNameOn: 'glyphicons eye_open',
			fontSize: '16',
			color: '#999',
			offsetX: 5,
			offsetY: 0,
