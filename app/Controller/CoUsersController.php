 ...
 */
	...
	public function participantes() 
	{
		...
		{		
			...
			//Listamos sólo los usuarios del Grupo Participantes
			$this->paginate = array('conditions'=>array('CoUser.co_group_id' => 2));			
 ...
 * confirmacion method
 *
 * Muestra la hoja de confirmación de registro
 * en la cual se enlista la información del usuario para su impresión
 * @return void
 */
 ...
 *
 * Recibe como parametro el id del usuario, enviado previamente mediante el lector de código de barras
 ...
 */
	public function registro() 
	{
		...
		//Verificamos si se requiere código de invitación..
		if ($evento['Evento']['requerir_codigo'])
		{
			//Validamos si ya se tiene validado el código mediante la sesion
			$validado=$this->Session->read('codigo_verificado');
			
			//Si no se tiene en sesión redirigir..
			if (!$validado)			
			...
			//verificamos este hábilitado el medio
