...
<div class="col-md-2 well2">
    ...
    <ul class="nav">
<?php
    echo "\t\t<li><?php echo \$this->Html->link('<i class=\"glyphicon glyphicon-edit\"></i> Editar', array('action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}']),array('class' => 'submenu-item','escape'=>false)); ?> </li>\n";
    echo "\t\t<li><?php echo \$this->Form->postLink('<i class=\"glyphicon glyphicon-remove\"></i> Eliminar', array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']),array('class' => 'submenu-item','escape'=>false), __('Are you sure you want to delete # %s?', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?> </li>\n";
    echo "\t\t<li><?php echo \$this->Html->link('<i class=\"glyphicon glyphicon-list\"></i> Listado', array('action' => 'index'),array('class' => 'submenu-item','escape'=>false)); ?> </li>\n";
    echo "\t\t<li><?php echo \$this->Html->link('<i class=\"glyphicon glyphicon-plus\"></i> Nuevo', array('action' => 'add'),array('class' =>'submenu-item','escape'=>false)); ?> </li>\n";
...
<div class="col-md-10">
    <h3><?php echo "Informaci&oacute;n de {$singularHumanName}"; ?></h3>
