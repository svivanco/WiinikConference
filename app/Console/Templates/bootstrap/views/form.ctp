...
<?php if (strpos($action, 'add') === false): ?>
        <li><?php echo "<?php echo \$this->Form->postLink('<i class=\"glyphicon glyphicon-remove\"></i> Eliminar', array('action' => 'delete', \$this->Form->value('{$modelClass}.{$primaryKey}')),array('class'=>'btn','escape'=>false), __('Realmente desea eliminar el registro con Id %s?', \$this->Form->value('{$modelClass}.{$primaryKey}'))); ?>"; ?></li>
<?php endif; ?>
        <li><?php echo "<?php echo \$this->Html->link('<i class=\"glyphicon glyphicon-list\"></i> Listado', array('action' => 'index'),array('class'=>'btn','escape'=>false)); ?>"; ?></li>
        <?php
        /*$done = array();
