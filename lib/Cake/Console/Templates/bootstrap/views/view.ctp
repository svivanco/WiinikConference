...
<div class="col-md-2 well">
    ...
    <ul class="nav">
<?php
    echo "\t\t<li><?php echo \$this->Html->link('Editar', array('action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?> </li>\n";
    echo "\t\t<li><?php echo \$this->Form->postLink('Eliminar', array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), null, __('Are you sure you want to delete # %s?', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?> </li>\n";
    echo "\t\t<li><?php echo \$this->Html->link('Listado', array('action' => 'index')); ?> </li>\n";
    echo "\t\t<li><?php echo \$this->Html->link('Nuevo', array('action' => 'add')); ?> </li>\n";
